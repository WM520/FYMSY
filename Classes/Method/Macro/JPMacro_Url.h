...
// !!!:生产环境
//  极光推送alias
//static NSString *const ib_JPushAliasUrl = @"http://10.10.100.12:8083/cpay-acps-push/fyMchnt/ios/login";
//  退出登录
//static NSString *const ib_JPushLogoutUrl = @"http://10.10.100.12:8083/cpay-acps-push/fyMchnt/ios/logout";
